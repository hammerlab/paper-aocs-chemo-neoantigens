...
\item As sample type is a confounding variable we additionally performed an unpaired analysis (figure 2) stratified by sample tissue type (solid or ascites). Increase in peptides for ascites and solid. For ascites, increase in expressed peptides. Only one solid tumor recurrence had RNA, and it had fewer expresssed peptides. Mean increase was
