...
\subsection*{Samples, clinical definitions, and mutation calls}
We analyzed the mutation calls published by Patch et al~\cite{Patch_2015} in their cohort of 114 high grade serous ovarian carcinoma samples. We combined adjacent SNVs from the same patient to form MNVs. DNA and RNA sequencing reads were downloaded from the European Genome-phenome Archive (accession EGAD00001000877). As in Patch et al, one sample (AOCS-002) under this accession was excluded because it was not classified as high grade serous. We classified samples as neoadjuvant-treated if they were documented as having received chemotherapy and had a specimen collection point of ``primary''; other treated samples were considered to be adjuvant-treated.
