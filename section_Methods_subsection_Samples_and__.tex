...
We analyzed the mutation calls published by Patch et al~\cite{Patch_2015} in their cohort of 114 high grade serous ovarian carcinoma samples. We combined adjacent SNVs from the same patient to form MNVs. DNA and RNA sequencing reads were downloaded from the European Genome-phenome Archive (accession EGAD00001000877). As in Patch et al, one sample (AOCS-002) under this accession was excluded because it was not classified as high grade serous. For samples taken after chemotherapy treatment, we defined those listed with a collection point of ``primary'' as neoadjuvant-treated and those with a collection point of ``recurrence'' or ``autopsy'' as adjuvant-treated.
