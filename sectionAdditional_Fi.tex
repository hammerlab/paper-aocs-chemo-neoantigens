...
\caption{\textbf{Mutational signature deconvolutions for all samples.} See (Figure~\ref{fig:signatures}) in the main text.}
...
\caption{Extracted signatures chicken.  and }
