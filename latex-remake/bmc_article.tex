...
To explore potential effects of changes in neoantigen burden, we investigated relationships among neoantigens, immune infiltrate from RNA-seq, and patient survival.

Predicted neoantigen burden at the primary/untreated time point was a superior predictor of survival than overall mutation burden (Figure~SX). In a Cox proportional hazards regression analysis, mean/variance standardized neoantigen count was associated with a hazard ratio (HR) of 0.77 (95\% CI 0.57--1.02, p=0.07). Expressed neoantigen burden showed a similar protective trend (HR=0.78 (0.59--1.03), p=0.08), whereas whole-genome mutation burden was not associated with survival (HR=1.0 (0.69--1.44), p=0.9). Investigation revealed that the latter result was strongly affected by sample AOCS-166, from a patient with one of the shortest survival times in the cohort (195 days), but over 66\% more mutations than any other sample, a consequence of a germline deficiency in mismatch repair. With this sample excluded, neoantigen count (HR=0.73 (0.54--0.97), p=0.03) and expressed neoantigen count (HR=0.75 (0.56--0.99), p=0.04) were positively associated with survival time, but mutation burden exhibited only a modest trend in this direction (HR=0.85 (0.65--1.11), p=0.2).

% Patients whose primary/untreated sample harbored greater predicted neoantigen burden showed a trend toward improved survival; remarkably, this effect was not observed for overall mutation burden .
