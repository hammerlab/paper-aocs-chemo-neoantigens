...
Nevertheless, a role for neoantigens in HGSC is suggested by our observation that in primary/untreated samples, neoantigen burden was more closely associated with survival than overall mutation burden. This effect was not explainable by concomitant CD8+ T cell infiltration in the primary tumor, as both independently associated with survival and did not strongly correlate with each other. It's well appreciated that both neoantigens and CD8+ T cell infiltrate are good things in a variety of tumor types, and our results add one more example to this picture. On the other hand, studies in other tumor types have reported associations between neoantigen burden and markers of tumor infiltrating lymphocytes~\cite{Rooney_2015,Giannakis2016}. Our smaller sample size may explain the lack of significant association; disease-intrinsic factors may also be involved. As tumor samples are a snapshot of a dynamically evolving equilibrium, in which increased neoantigens may pull in T cells, which, through a process termed immunoediting~\cite{Dunn2002}, select for a loss of neoantigens, samples with low neoantigen burden and high immune infiltration may have exprienced selective loss of neoantigens. Other reports have found evidence for such a process~\cite{Rooney_2015}, and, while we did not pursue it in the present study, this dataset would be an interesting basis for such investigation. 
