...
\end{tabular}
\hspace{\linewidth}
\caption{Sample counts by tissue and chemotherapy exposure. Parentheses indicate chemotherapy-treated samples with a patient-matched primary/untreated sample.}\label{tab:samples}
