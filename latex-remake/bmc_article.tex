...
Cycles:
 - Chemo signatures showed a dose-dependent relationship with chemo cycles

CIBERSORT:
 - Ascites have low T cells, high monocytes
 - Considered interactions between: chemo cycles and ascites T cells / monocytes, neoantigens and ascites T cells / monocytes, solid tumor T cells and survival, soldi tumor T cells and neoantigens, neoantigens and surviavl
 
SURVIVAL:
- trend toward improved survival with greater neoantigen burden in primary tumor
- improved survival with more T cells in primary tumor

Figures:
- Survival plot: mutations, neoantigens, expressed neoantigens, CD8+ T cells
- Big immune deconvolution matrix
- Neoantigens vs CD8 T cells
- Chemo cycles vs chemo signatures
