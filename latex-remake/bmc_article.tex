...
\end{tabular}
\hspace{\linewidth}
\caption{Sample counts by tissue and chemotherapy exposure. Parentheses indicate chemotherapy-treated samples with a patient-matched primary/untreated sample. Cyc., cyclophosphamide.}\label{tab:samples}
...
Across the cohort, we identified 17,689 mutated peptides predicted to bind autologous MHC class I with affinity 500nm or tighter~\cite{Sette1994}. All but 21 (0.12\%) of these predicted neoantigens were private to a single patient. Shared neoantigens, which include common mutations in TP53, DNMT1 (shared neoantigens are listed in Additional File 6).
