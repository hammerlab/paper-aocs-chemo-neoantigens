...
Clinically, while relapse tumors may be expected to harbor more potential neoantigens, our results suggest it would be difficult to rationally increase neoantigen burden through manipulation of chemotherapy dosage, as even the most heavily treated patients in this cohort show only a modest number chemotherapy-induced neoantigens. The patient with the most chemotherapy induced neoantigens, AOCS-092, had 9/61 neoantigens attributed to chemotherapy. Applying the Cox proportional hazards model fit on the full cohort to this patient, 9 additional neoantigens are predicted to improve two year survival by only 1.1 percentage points (from 43.7\% to 44.8\%).  Moreover, as immunotherapy trials in ovarian cancer have been in the setting of heavily pre-treated recurrent disease and yet have largely failed to achieve durable responses, the significantly increased all-cause neoantigen burden at recurrence is evidently not sufficient on its own to render immunotherapy effective. Other factors besides neoantigens, for example the unique immunosuppressive environment of ascites, may need to be overcome for immunotherapy to be effective in this disease.
