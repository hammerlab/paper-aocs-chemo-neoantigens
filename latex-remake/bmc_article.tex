...
NACT-treated tumors, which were exposed to chemotherapy as large tumors and for a short duration (typically 3 cycles), did not show increased mutation or neoantigen burden over untreated samples and had very few mutations attributed to chemotherapy. This is likely because individual chemotherapy-induced mutations remain confined to subclones too rare for detection by bulk sequencing in the absence of the population bottleneck created by surgery and/or the multiple lines of chemotherapy provided in the adjuvant setting.
