...
Relapsed HGSC tumors harbor more predicted expressed neoantigens than primary samples, but the increase is primarily due to pre-existing mutational processes and clonal outgrowth following treatment, not direct mutagenesis from chemotherapy. Our analyses are based on sequencing of bulk samples and do not account for neoantigens present in small populations of cells. 
